 ...
 */
public class msg_gh_cmd_ack extends MAVLinkMessage {

    public static final int MAVLINK_MSG_ID_GH_CMD_ACK = 21001;
    public static final int MAVLINK_MSG_LENGTH = 10;
    private static final long serialVersionUID = MAVLINK_MSG_ID_GH_CMD_ACK;
    ...
    public MAVLinkPacket pack() {
        ...
        packet.msgid = MAVLINK_MSG_ID_GH_CMD_ACK;
    ...
    /**
     * Decode a gh_cmd_ack message into this class fields
     *
     ...
     */
    public msg_gh_cmd_ack() {
        this.msgid = MAVLINK_MSG_ID_GH_CMD_ACK;
    }

    /**
     * Constructor for a new message, initializes msgid and all payload variables
     */
    public msg_gh_cmd_ack( int command, short result, short progress, int result_param2, short target_system, short target_component) {
        this.msgid = MAVLINK_MSG_ID_GH_CMD_ACK;
     ...
     */
    public msg_gh_cmd_ack( int command, short result, short progress, int result_param2, short target_system, short target_component, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_GH_CMD_ACK;
        this.sysid = sysid;
        this.compid = compid;
     ...
     *
     */
    public msg_gh_cmd_ack(MAVLinkPacket mavLinkPacket) {
        this.msgid = MAVLINK_MSG_ID_GH_CMD_ACK;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_GH_CMD_ACK - sysid:"+sysid+" compid:"+compid+" command:"+command+" result:"+result+" progress:"+progress+" result_param2:"+result_param2+" target_system:"+target_system+" target_component:"+target_component+"";
    }
    ...
    @Override
    public String name() {
        return "MAVLINK_MSG_ID_GH_CMD_ACK";
    }
}
